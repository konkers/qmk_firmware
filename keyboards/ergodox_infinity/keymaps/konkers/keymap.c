...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
     KC_ESCAPE, KC_1,    KC_2,    KC_3,  KC_4,    KC_5, KC_TR,
     KC_GRAVE,  KC_Q,    KC_W,    KC_E,  KC_R,    KC_T, KC_LBRACKET,
     KC_TR,     KC_A,    KC_S,    KC_D,  KC_F,    KC_G,
     KC_LSHIFT, KC_Z,    KC_X,    KC_C,  KC_V,    KC_B, KC_EQUAL,
     KC_LCTL,   KC_LALT, KC_LGUI, KC_TR, KC_LGUI,

                         ALT_T(KC_APPLICATION), KC_LGUI,
                                                KC_HOME,
                         KC_SPACE, KC_TAB,      LGUI(LSFT(KC_SPACE)),


     KC_MINUS,    KC_6,    KC_7,  KC_8,     KC_9,   KC_0,            KC_MINUS,
     KC_RBRACKET, KC_Y,    KC_U,  KC_I,     KC_O,   KC_P,            KC_BSLASH,
                  KC_H,    KC_J,  KC_K,     KC_L,   LT(2,KC_SCOLON), GUI_T(KC_QUOTE),
     MO(1),       KC_N,    KC_M,  KC_COMMA, KC_DOT, CTL_T(KC_SLASH), KC_RSHIFT,
